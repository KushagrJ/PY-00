...
#  * The for loop iterates through iterable collections, whereas the while loop simply loops until the specified
#    condition is false - This should be used to know whether to use the for loop or the while loop.
